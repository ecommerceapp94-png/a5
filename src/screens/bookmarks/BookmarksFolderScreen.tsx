...
const MOCK_PRIMARY: MockEntry[] = [
  ...
  {
    id: 'item-2149-27',
    title: 'Vibrant Quest 27',
    description: 'across long remaining fast fast alive with long that for and and with on. considered designed fluid A across pixel experience alive press alive experience gestures designed alive or in press and. beautiful considered dark for alive and curated across forever alive gestures modes',
    icon: 'image',
    gradient: 'fire',
    tone: 'success',
    meta: '20 mins ago',
  ...
  {
    id: 'item-2149-28',
    title: 'Polished Loom 28',
    description: 'long remaining fast fast alive with long that for and and with on haptics. fluid A across pixel experience alive press alive experience gestures designed alive or in press and considered or. for alive and curated across forever alive gestures modes dark feel modes',
    icon: 'school',
    gradient: 'sunset',
    tone: 'success',
    meta: '21 mins ago',
  ...
  },
  {
    ...
    description: 'remaining fast fast alive with long that for and and with on haptics in. across pixel experience alive press alive experience gestures designed alive or in press and considered or curated on. curated across forever alive gestures modes dark feel modes fluid curated forever',
...
const SECTIONS: SectionConfig[] = [
  {
    id: 'section-36533-1',
    title: 'Subtle Codex',
    subtitle: 'dark tap experience fast while and modes private fast and forever modes forever press. or tap while and in browsing and fluid tap every and private remaining considered pixel across across for. in every modes remaining forever browsing alive and or light forever every',
    icon: 'extension-puzzle',
    gradient: 'ocean',
  },
  {
    ...
    subtitle: 'modes forever press every haptics and remaining long feel fluid across alive curated or. designed and with feel private in alive or considered fast and long modes and every while experience considered. alive while and dark forever feel for fast fast while and or',
    icon: 'extension-puzzle',
    gradient: 'sunset',
  },
  {
    id: 'section-36533-3',
    title: 'Lush Atlas',
    subtitle: 'alive curated or and and and private while browsing beautiful remaining long for forever. A with for and remaining while or dark forever fluid fast alive every that press feel browsing gestures. forever private in fast curated haptics forever across alive in A long',
    icon: 'pizza',
    gradient: 'candy',
  },
  {
    id: 'section-36533-4',
    title: 'Elite Codex',
    subtitle: 'long for forever forever modes press while modes light designed and press beautiful designed. alive tap or and or long alive remaining that every feel designed forever forever with haptics A long. for pixel beautiful haptics every A with designed private and while and',
    icon: 'pricetag',
    gradient: 'brand',
  },
  {
    id: 'section-36533-5',
    title: 'Snappy Lens',
    subtitle: 'press beautiful designed for modes gestures dark and and for and light that that. curated while fluid every tap beautiful browsing alive fast feel every every private for beautiful that and fast. A tap dark A with fast beautiful remaining modes fluid alive or',
    icon: 'eye',
    gradient: 'aurora',
  },
  {
    id: 'section-36533-6',
    title: 'Subtle Quest',
    subtitle: 'light that that experience long across that modes pixel forever forever that that light. designed private and considered alive A forever that experience experience every alive beautiful light curated press designed while. and and forever and every private curated light while gestures forever press',
    icon: 'shield',
    gradient: 'forest',
  },
  {
    id: 'section-36533-7',
    title: 'Cosmic Loom',
    subtitle: 'that that light forever every that A long experience dark every fluid and alive. every press and and feel remaining fast feel or long long dark gestures experience gestures light that alive. haptics in beautiful haptics or and light browsing on light modes forever',
    icon: 'flame',
    gradient: 'fire',
  },
  {
    id: 'section-36533-8',
    title: 'Snappy Drift',
    subtitle: 'fluid and alive dark light and modes remaining experience considered remaining every forever light. for alive private gestures gestures that haptics while A every tap alive with across that tap with dark. dark beautiful modes curated or fast while haptics browsing and and in',
    icon: 'book',
    gradient: 'neon',
  },
  {
    id: 'section-36533-9',
    title: 'Brisk Halo',
    subtitle: 'every forever light considered forever feel in long every with private gestures fluid and. experience experience dark every fluid feel in across press pixel considered across considered curated gestures browsing and on. tap private while across remaining and fluid while designed feel alive fluid',
    icon: 'compass',
    gradient: 'ocean',
  },
  {
    id: 'section-36533-10',
    title: 'Subtle Spark',
    subtitle: 'gestures fluid and beautiful fluid beautiful on pixel beautiful every beautiful light remaining A. that beautiful and designed A while fluid and with and gestures browsing considered in experience browsing gestures private. tap haptics with pixel feel across curated A modes beautiful curated press',
    icon: 'sparkles',
    gradient: 'amber',
  },
  {
    id: 'section-36533-11',
    title: 'Dreamy Codex',
    subtitle: 'light remaining A long considered long feel in fast and on with across across. in designed and alive light designed alive and dark on experience press that light and alive that considered. dark light and alive press fluid and on haptics designed or alive',
    icon: 'cafe',
    gradient: 'aurora',
  },
  {
    id: 'section-36533-12',
    title: 'Crisp Insight',
    subtitle: 'with across across browsing and browsing considered and while modes designed remaining gestures tap. or tap remaining for private across tap that every A experience pixel on long haptics light curated remaining. A A or or beautiful considered every alive while beautiful remaining alive',
    icon: 'flag',
    gradient: 'cosmic',
  },
  {
    id: 'section-36533-13',
    title: 'Frosted Halo',
    subtitle: 'remaining gestures tap for press fast fast alive and for private A fast and. on private considered tap on and haptics dark beautiful every alive fluid for press and private tap alive. on remaining gestures with fluid haptics considered and feel while modes every',
    icon: 'layers',
    gradient: 'pastel',
  },
  {
    id: 'section-36533-14',
    title: 'Deep Loom',
    subtitle: 'A fast and while feel private across with pixel every forever across pixel curated. press considered every with curated with forever beautiful in pixel light alive alive A curated beautiful or dark. modes while every for across experience A forever long with considered light',
    icon: 'grid',
    gradient: 'forest',
  },
];

const HERO_TITLE = 'Folder';
const HERO_SUBTITLE = 'Bookmarks inside a folder.';
const FOOTER_TITLE = 'Keep going with Folder';
const FOOTER_BODY = 'gestures remaining press feel long beautiful private browsing forever private and pixel long long. beautiful and private for in pixel private alive A light every long light or dark across feel dark. with curated experience beautiful beautiful every fluid alive on haptics beautiful across';

export const BookmarksFolderScreen: React.FC = () => {
  ...
  return (
    ...
    >
      <ScreenHeader
        title="Folder"
        subtitle="Bookmarks inside a folder."
        showBack={true}
        rightIcon="folder"
          ...
          <NeumorphicSurface radius={26}>
            <View style={styles.barColumn}>
              <View style={styles.rowSpread}>
                <Text style={[styles.barTitle, { color: theme.colors.text }]}>Crisp Quest</Text>
